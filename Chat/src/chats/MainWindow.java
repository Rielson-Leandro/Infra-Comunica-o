...
public class MainWindow extends JFrame {
	...
	{
		System.out.println("tamanho deve enviadas"+pe.list_of_users.size());
		list.removeAll();
	...
	public MainWindow(String s) {
		...
		JButton btnNewButton = new JButton("Conversa em grupo");
		...
		btnConnect.addActionListener(new ActionListener() {
			...
			//	 System.out.println(list.getSelectedItem());
			    ...
			    else JOptionPane.showMessageDialog(contentPane, "este usuario está offline");
