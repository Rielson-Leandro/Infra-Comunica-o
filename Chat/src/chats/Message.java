...
public class Message implements Serializable{
    ...
    public enum MsgType {
        Enter_Name,//Sever pede cliente para identificação
        User_Name, //nome do usuário resposta do cliente e porta
        Create_Group,//pares envia uma solicitação de novo grupo
        List_Groups, //Lista de grupos disponíveis
        Join_Group,
        Conv_Msg,
        Group_Msg,
        List_Users, //Lista de usuários on-line
        Bye,
        group_chat_message,
